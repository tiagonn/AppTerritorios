...
public interface CadastroSurdoView extends CadastroView {
	...
	public interface Presenter extends CadastroView.Presenter {
		void onPesquisaPesquisarEvent(String identificadorCidade, String nomeSurdo, String nomeRegiao, String identificadorMapa, Boolean estaAssociadoMapa, Boolean dispararPesquisa);
