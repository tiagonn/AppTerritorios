					...
					.append("<tr><td width=100%>")
						.append("<table width=100% cellspacing=1 border=0>")
							...
							.append("<tr>")
								...
								.append("<td ").append(classe1).append(">Lat/Long:</td>")
							...
							.append("</tr>")
							.append("<tr>")
								.append("<td valign=top ").append(classe1).append(">Obs:</td>")
								.append("<td colspan=3 ").append(classe).append(surdo.getObservacaoConsolidada()).append("</td>")
							.append("</tr>")
						.append("</table>")
					.append("</td></tr>")
					.append("<tr><td>")
