...
import com.subshell.gwt.canvas.client.canvas.Canvas;
import com.subshell.gwt.canvas.client.canvas.Gradient;
import com.subshell.gwt.canvas.client.canvas.ImageData;
import com.subshell.gwt.canvas.client.canvas.RenderingContext;
	...
	public SaturationLightnessPicker() {
		...
		canvas.addMouseDownHandler(new MouseDownHandler() {
			public void onMouseDown(MouseDownEvent event) {
				handleX = event.getRelativeX(canvas.getElement())-10;
				handleY = event.getRelativeY(canvas.getElement())-10;
				drawGradient(false);
