...
public class MapeamentoNovosAtributosServlet extends
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		for (Surdo surdo : surdos) {
			logger.log(Level.INFO, "Mapeamento novos atributos de surdo id "
					+ surdo.getId());
			...
			surdoMapeado.setCidade(surdo.getCidade());
			...
			surdoMapeado.setVisitarSomentePorAnciaos(surdo
